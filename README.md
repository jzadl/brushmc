...
* **Overview** shows counts and recent items for all categories at a glance
...
The binary will be at `src-tauri/target/release/brush-mc.exe` on Windows, `brush-mc` on macOS/Linux.
